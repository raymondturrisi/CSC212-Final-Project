...
int main(int argc, char *args[]) {
    ...
    */
    ...
    std::vector<double> local_coords = {41, 41};
    std::cout << local_coords[0] << " " << local_coords[1] << std::endl;
    DefaultLocation r(2);

    best_distance = DBL_MAXT;
    t = tree.nearest_neighbor_oftype(local_coords, "automotive", best_distance);
    t.print_info();
    std::cout << "closest distance of euclidian Long/Lat: " << best_distance << std::endl;
    ...
    fname = working_directory + "2d_colored.csv";
    ...
    /*
    DefaultLocation barb(2);
    DefaultLocation larry(2);
    ...
    */
    ...
    fname = working_directory + "3d_colored.txt";
    ...
    for(int i = 0; i < cp3Dat.size(); i++) {
        best_distance = DBL_MAXT;
        t = tree3.nearest_neighbor(cp3Dat[i], best_distance);
        //cp3Dat[i].print_info();
        //t.print_info();
        //std::cout << "closest distance of euclidian distance: " << best_distance << std::endl;
        std::cout << cp3Dat[i].coords[0] << ", " << cp3Dat[i].coords[1] << ", " << cp3Dat[i].coords[2] << ", " << t.coords[0] << ", " << t.coords[1] << ", " << t.coords[2] << "\n"; //matlab formatted output for arrowed graph
    }
